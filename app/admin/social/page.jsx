...
const FacebookSvg = ({ className = "w-5 h-5" }) => (
...
const PinterestSvg = ({ className = "w-5 h-5" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
const PLATFORM_METADATA = [
    { key: "facebook", name: "Facebook", svg: FacebookSvg, placeholder: "https://facebook.com/chandjewelry.store", bgClass: "bg-[#1877F2] text-white" },
    { key: "instagram", name: "Instagram", svg: InstagramSvg, placeholder: "https://instagram.com/chandjewelry.store", bgClass: "bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white" },
    { key: "whatsapp", name: "WhatsApp", svg: WhatsappSvg, placeholder: "https://wa.me/923255821056", bgClass: "bg-[#25D366] text-white" },
    { key: "twitter", name: "Twitter / X", svg: TwitterSvg, placeholder: "https://x.com/chandjewelry", bgClass: "bg-black text-white" },
    { key: "youtube", name: "YouTube", svg: YoutubeSvg, placeholder: "https://youtube.com/@chandjewelry", bgClass: "bg-[#FF0000] text-white" },
    { key: "tiktok", name: "TikTok", svg: TiktokSvg, placeholder: "https://tiktok.com/@chandjewelry", bgClass: "bg-[#000000] text-white" },
    { key: "linkedin", name: "LinkedIn", svg: LinkedinSvg, placeholder: "https://linkedin.com/company/chandjewelry", bgClass: "bg-[#0A66C2] text-white" },
    { key: "pinterest", name: "Pinterest", svg: PinterestSvg, placeholder: "https://pinterest.com/chandjewelry", bgClass: "bg-[#BD081C] text-white" },
]
